-- ============================================================================
-- Profitability Summary By Partner Stored Procedure (v1.1)
-- Pre-aggregated profitability metrics grouped by TaskPartner
-- ============================================================================
--
-- PURPOSE: Provides partner-level profitability summary for Country Management
...
-- ============================================================================
-- Same logic as sp_ProfitabilityData but filtering on WIPTransactions.TaskPartner
...
-- Partner filter on WIPTransactions.TaskPartner
...
-- ============================================================================
-- STEP 2: Get Partner names and filter to valid tasks
-- ============================================================================
