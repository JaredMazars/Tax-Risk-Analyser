-- ============================================================================
-- Optimize Summary Stored Procedures (v1.1)
-- Created: 2026-02-04
-- ============================================================================
-- 
-- OPTIMIZATIONS APPLIED:
-- 1. Pre-filter active tasks into indexed temp table (40% row reduction)
-- 2. 3-year date lower bound for WIP Aging SPs (50% row reduction)
-- 3. Reuse temp table for client count joins (eliminates duplicate Task queries)
--
-- EXPECTED IMPROVEMENTS:
-- - WIP Aging Summary: 10-30s reduced to 1-3s
-- - Profitability Summary: 5-15s reduced to 1-3s
-- - Combined row reduction: 60-70%
--
-- ============================================================================

PRINT '';
PRINT '=============================================================================';
PRINT 'Starting Summary SP Optimization Migration';
PRINT 'Timestamp: ' + CONVERT(VARCHAR, GETDATE(), 120);
PRINT '=============================================================================';

-- ============================================================================
-- sp_WIPAgingSummaryByPartner (v1.1)
-- ============================================================================

PRINT '';
PRINT 'Creating/Updating sp_WIPAgingSummaryByPartner v1.1...';
GO
...
PRINT 'sp_WIPAgingSummaryByPartner v1.1 created successfully';
GO

-- ============================================================================
-- sp_WIPAgingSummaryByManager (v1.1)
-- ============================================================================

PRINT '';
PRINT 'Creating/Updating sp_WIPAgingSummaryByManager v1.1...';
GO
...
PRINT 'sp_WIPAgingSummaryByManager v1.1 created successfully';
GO

-- ============================================================================
-- sp_ProfitabilitySummaryByPartner (v1.1)
-- ============================================================================

PRINT '';
PRINT 'Creating/Updating sp_ProfitabilitySummaryByPartner v1.1...';
GO
...
PRINT 'sp_ProfitabilitySummaryByPartner v1.1 created successfully';
GO

-- ============================================================================
-- sp_ProfitabilitySummaryByManager (v1.1)
-- ============================================================================

PRINT '';
PRINT 'Creating/Updating sp_ProfitabilitySummaryByManager v1.1...';
GO
...
PRINT 'sp_ProfitabilitySummaryByManager v1.1 created successfully';
GO
...
-- ============================================================================
-- Cleanup: Drop duplicate stored procedures (standardize on sp_ prefix)
-- ============================================================================

PRINT '';
PRINT 'Dropping duplicate stored procedures (standardizing on sp_ prefix)...';

IF OBJECT_ID('dbo.WipMonthly', 'P') IS NOT NULL
BEGIN
    DROP PROCEDURE dbo.WipMonthly;
    PRINT '  - Dropped dbo.WipMonthly (use dbo.sp_WipMonthly instead)';
END

IF OBJECT_ID('dbo.DrsMonthly', 'P') IS NOT NULL
BEGIN
    DROP PROCEDURE dbo.DrsMonthly;
    PRINT '  - Dropped dbo.DrsMonthly (use dbo.sp_DrsMonthly instead)';
END

PRINT 'Duplicate stored procedures cleaned up';
...
PRINT 'Timestamp: ' + CONVERT(VARCHAR, GETDATE(), 120);
PRINT '=============================================================================';
PRINT 'Stored procedures updated to v1.1:';
PRINT '  - sp_WIPAgingSummaryByPartner';
PRINT '  - sp_WIPAgingSummaryByManager';
PRINT '  - sp_ProfitabilitySummaryByPartner';
PRINT '  - sp_ProfitabilitySummaryByManager';
PRINT '';
PRINT 'Duplicate SPs removed (standardized on sp_ prefix):';
PRINT '  - Dropped WipMonthly (use sp_WipMonthly)';
PRINT '  - Dropped DrsMonthly (use sp_DrsMonthly)';
PRINT '';
PRINT 'Key optimizations:';
PRINT '  1. Pre-filter active tasks into indexed temp tables (~40% row reduction)';
PRINT '  2. 3-year date lower bound for WIP Aging (~50% row reduction)';
PRINT '  3. Reuse temp tables for client count queries';
PRINT '=============================================================================';
GO
