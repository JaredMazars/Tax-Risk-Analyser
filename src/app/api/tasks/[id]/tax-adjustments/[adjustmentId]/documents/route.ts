...
export async function POST(
  ...
  try {
    ...
    return handleApiError(error, 'POST /api/tasks/[id]/tax-adjustments/[adjustmentId]/documents');
  }
}
...
export async function GET(
  ...
  try {
    ...
    return handleApiError(error, 'GET /api/tasks/[id]/tax-adjustments/[adjustmentId]/documents');
  }
}
