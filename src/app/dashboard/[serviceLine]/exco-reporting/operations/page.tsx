...
const reports = [
  {
    ...
    description: 'Individual and team performance metrics, KPIs, and productivity analysis',
    icon: UserCheck,
  },
  {
    id: 'utilization',
    name: 'Utilization Dashboard',
    description: 'Billable hours, capacity utilization, and resource efficiency metrics',
    icon: Clock4,
  },
  {
    id: 'partner-metrics',
    name: 'Partner Metrics',
    description: 'Partner productivity, contribution analysis, and portfolio performance',
    icon: Briefcase,
  },
  {
    id: 'service-line-performance',
    name: 'Service Line Performance',
    description: 'Comparative analysis and performance metrics across all service lines',
    icon: LayoutGrid,
  },
];
    ...
    <div className="min-h-screen bg-forvis-gray-50">
      <div className="w-full px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-forvis-gray-600 mb-6">
          ...
          <ChevronRight className="h-4 w-4" />
          <span className="text-forvis-gray-900 font-medium">Operations & Productivity</span>
        </nav>
          ...
          <div className="flex items-center gap-4 mb-2">
            ...
            <div>
              ...
              <p className="text-sm text-forvis-gray-600">
                Staff performance, utilization, partner metrics, and service line analysis
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {reports.map((report) => {
            ...
            return (
              <Link
                key={report.id}
                href={`/dashboard/${serviceLine.toLowerCase()}/exco-reporting/operations/${report.id}`}
