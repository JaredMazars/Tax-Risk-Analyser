...
const reports = [
  {
    ...
    description: 'Client risk assessment, value analysis, and portfolio tier distribution',
    icon: Building2,
  },
  {
    id: 'sector-analysis',
    name: 'Sector Analysis',
    description: 'Performance breakdown by industry sector and market segment',
    icon: PieChart,
  },
  {
    id: 'pipeline',
    name: 'Pipeline Overview',
    description: 'Business development opportunities, win rates, and pipeline value',
    icon: TrendingUp,
  },
  {
    id: 'new-business',
    name: 'New Business Report',
    description: 'Recently acquired clients, new engagements, and growth metrics',
    icon: Sparkles,
  },
];
    ...
    <div className="min-h-screen bg-forvis-gray-50">
      <div className="w-full px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-forvis-gray-600 mb-6">
          ...
          <ChevronRight className="h-4 w-4" />
          <span className="text-forvis-gray-900 font-medium">Strategic</span>
        </nav>
          ...
          <div className="flex items-center gap-4 mb-2">
            ...
            <div>
              ...
              <p className="text-sm text-forvis-gray-600">
                Client portfolio, sector analysis, pipeline overview, and new business reports
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {reports.map((report) => {
            ...
            return (
              <Link
                key={report.id}
                href={`/dashboard/${serviceLine.toLowerCase()}/exco-reporting/strategic/${report.id}`}
