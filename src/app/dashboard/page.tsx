    ...
    <div className="min-h-screen bg-forvis-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-forvis-gray-900 mb-4">
            Welcome to Forvis Mazars Professional Services
          </h1>
          <p className="text-lg text-forvis-gray-700">
        ...
        {/* Info Section */}
        <div className="mt-16 bg-white rounded-xl shadow-md p-8 border border-forvis-gray-200">
          <h2 className="text-2xl font-bold text-forvis-gray-900 mb-4">
            About Our Service Lines
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="font-semibold text-forvis-gray-900 mb-2">Tax</h3>
