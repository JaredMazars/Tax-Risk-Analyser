...
/**
 * WIP Aging Partner Summary Table Component
 * 
 * Displays pre-aggregated WIP aging buckets by partner from summary SP
...
interface WIPAgingPartnerSummaryTableProps {
...
type SortKey = 'PartnerName' | 'TaskCount' | 'ClientCount' | 'Curr' | 'Bal30' | 'Bal60' | 'Bal90' | 'Bal120' | 'Bal150' | 'Bal180' | 'BalWIP' | 'NettWIP';

export function WIPAgingPartnerSummaryTable({ data, onPartnerClick }: WIPAgingPartnerSummaryTableProps) {
