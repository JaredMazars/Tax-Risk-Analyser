...
/**
 * Manager Summary Table Component
 * 
 * Displays pre-aggregated profitability totals by manager from summary SP
...
interface ManagerSummaryTableProps {
...
type SortKey = 'ManagerName' | 'TaskCount' | 'ClientCount' | 'BalWip' | 'NetWIP' | 'NetRevenue' | 'LTDCost' | 'GrossProfit' | 'GPPercentage';

export function ManagerSummaryTable({ data, onManagerClick }: ManagerSummaryTableProps) {
