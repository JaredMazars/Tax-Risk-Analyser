...
export function WIPAgingSubServiceLineGroupTotalsTable({ tasks }: WIPAgingSubServiceLineGroupTotalsTableProps) {
  ...
  const groupedData = useMemo(() => {
    ...
    return Array.from(slMap.values()).sort((a, b) => 
      a.subServlineGroupDesc.localeCompare(b.subServlineGroupDesc)
    );
  }, [tasks]);
      ...
      <div className="inline-block min-w-full align-middle">
        ...
        <div
          ...
          style={{
            ...
            gridTemplateColumns: '2fr 1fr 70px 90px 90px 90px 90px 90px 90px 90px 100px 100px 90px 100px',
          }}
        >
        ...
        <div className="bg-white">
          {paginatedData.map((item, index) => (
            <div
              ...
              style={{ gridTemplateColumns: '2fr 1fr 70px 90px 90px 90px 90px 90px 90px 90px 100px 100px 90px 100px' }}
            >
